      ...
      <div className="project--wrapper">
        ...
        <div className="project--card">
          ...
          <div className="project--card__content">
            ...
            <p className="project--card__content__desc">
            This is a front-end solution. Frontend Mentor Challenge created a visually stunning chat app illustration with CSS and HTML. In this project, I created the entire app illustration from scratch.
            </p>
          </div>
          <div className="project--card__links">
            <Link
        ...
        <div className="project--card">
          ...
          <div className="project--card__content">
            ...
            <p className="project--card__content__desc">
              This is the solution to Fylo data storage component on Frontend Mentor Challenge.
            </p>
          </div>
          <div className="project--card__links">
            <Link
