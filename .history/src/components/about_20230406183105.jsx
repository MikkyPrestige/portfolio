...
const AboutMe = () => {
  return (
    <div className="app">
      <div className="about">
      <Bounce duration={5000} cascade damping={.5} onVisibilityChange>
            ...
            <div className="about--content">
              ...
              <div className="about--content__text">
                ...
                <p className="about--content__text__desc">
                  ...
                  entry-level developer, I am dedicated to delivering clean and
                  efficient code, effectively collaborating with my team, and
                  constantly striving for growth and improvement. I am excited
                  about the opportunity to contribute to a company's success
                  while also further developing my skills in a dynamic and
