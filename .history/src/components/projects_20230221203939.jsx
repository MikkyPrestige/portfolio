      ...
      <div className="project--wrapper">
        ...
        <div className="project--card">
          ...
          <div className="project--card__content">
            ...
            <p className="project--card__content__desc">
              This is a card component built with HTML and CSS from Frontend Mentor Challenge.
            </p>
          </div>
          <div className="project--card__links">
            <Link
        ...
        <div className="project--card">
          ...
          <div className="project--card__content">
            ...
            <p className="project--card__content__desc">
              This is a solution to the Stats preview card component Frontend Mentor Challenge
            </p>
          </div>
          <div className="project--card__links">
            <Link
