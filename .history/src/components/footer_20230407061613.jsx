...
from,
  ...
  22.2% {
    -webkit-transform: skewX(-11.5deg) skewY(9.5deg);
    transform: skewX(-11.5deg) skewY(9.5deg);
  }

  33.3% {
    -webkit-transform: skewX(5.25deg) skewY(3.25deg);
    transform: skewX(5.25deg) skewY(3.25deg);
  }

  44.4% {
    -webkit-transform: skewX(-3.125deg) skewY(-1.125deg);
    transform: skewX(-3.125deg) skewY(-1.125deg);
  }
