...
import { Reveal, JackInTheBox } from "react-awesome-reveal";
      ...
      <div className="home">
        ...
        <div className="home--contents">
          <div className="home--contents__wrapper">
            <JackInTheBox
            duration={5000}
            className="home--contents__content"
            >
              <div>
            ...
            <Reveal keyframes={rotateInDownRight} duration={5000} className="home--contents__illustration">
              <div>
          ...
          <Reveal keyframes={backInLeft} className="home--contents__quote">
          <figure>
            <blockquote
