      ...
      <div className="project--wrapper">
        ...
        <div className="project--card">
          ...
          <div className="project--card__content">
            ...
            <p className="project--card__content__desc">
              This is a web app that uses the GitHub API to display a user's repositories. It was built with React.
            </p>
            </div>
            <div className="project--card__links">
              <Link
              ...
              <div className="project--card">
                ...
                <div className="project--card__content">
                  ...
                  <p className="project--card__content__desc">
                    This is a landing page for a fictional company called Trillo. It was built with HTML, CSS and SASS.
                  </p>
                  </div>
                  <div className="project--card__links">
                    <Link
                      to={{ pathname: "https://github.com/MeekyBerry/Advanced-CSS-Sass-Course-Projects/tree/master/Trillow-project" }}
                      target="_blank"
                      className="project--card__links__link"
                    >
                      View on GitHub
                      ...
                      <Link
                      to={{ pathname: "https://fantastic-crostata-3e9a02.netlify.app/" }}
                      target="_blank"
                      className="project--card__links__link"
                      >
                      View Live
