        ...
        <div className="project--card">
          ...
          <div className="project--card__content">
            ...
            <p className="project--card__content__desc">
              ...
              entered by the user. It has a customizable tip percentage array with a "Custom" button for entering a specific tip percentage. The calculator also has a reset button and input validation to ensure that input values are not zero.
            </p>
          </div>
