            ...
            <div className="project--card">
              ...
              <article className="project--card__side project--card__side__back">
                <div className="project--card__content">
                  ...
                  <p className="project--card__content__desc">
                    This is an interactive web page that displays a rating component in numbers. It allows the user select and submit a number rating.
                    This is a solution for the <mark>Frontend Mentor Challenge</mark>,
                    'Interactive rating component'.
                  </p>
                </div>
                <div className="project--card__links">
