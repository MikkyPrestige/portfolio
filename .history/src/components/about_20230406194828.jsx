          ...
          <Zoom duration={5000} cascade damping={0.00001}>
            ...
            <div className="about--skills">
              <div className="about--skills__title">
                ...
                <div className="about--skills__title__avatar animate__animated animate__tada">
                  <Avatar
                    image={Skills}
                    alt="skills-logo"
              ...
              <div className="about--skills__content">
                <div className="about--skills__content__items">
                  <div className="about--skills__content__items__card">
                    <div className="about--skills__content__items__card__avatar">
                      <Avatar
                        image={HTML5}
                        alt="html5-logo"
                        style={{ width: "100%", height: "100%" }}
                  ...
                  <div className="about--skills__content__items__card">
                    <div className="about--skills__content_items__card_avatar">
                      <Avatar
                        image={FIGMA}
                        alt="figma-logo"
                        style={{ width: "100%", height: "100%" }}
