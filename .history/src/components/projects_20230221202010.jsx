      ...
      <div className="project--wrapper">
        ...
        <div className="project--card">
          ...
          <div className="project--card__content">
            ...
            <p className="project--card__content__desc">
            This a Landing page built with HTML, CSS and little Javascript. Sass was also used but only for the Nesting elements feature. It was a code along project on "Learn HTML & CSS in 2022 crash course" by Design Course.
            </p>
          </div>
          <div className="project--card__links">
            <Link
