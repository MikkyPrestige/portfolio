        ...
        <div className="contact--location__map">
          ...
          <div className="contact--location__map--menu">
            <div className="contact--location__map--menu__item">
              ...
              />
              <label htmlFor="satellite-streets-v12" className="contact--location__map--menu__item--input">Satellite Street</label>
            </div>
            <div className="contact--location__map--menu__item">
              <input
                type="radio"
                ...
                className="contact--location__map--menu__item--input"
              />
              <label htmlFor="light-v10" className="contact--location__map--menu__item--input">Light</label>
            </div>
            <div className="contact--location__map--menu__item">
              <input
                type="radio"
                ...
                className="contact--location__map--menu__item--input"
              />
              <label htmlFor="dark-v10" className="contact--location__map--menu__item--input">Dark</label>
            </div>
            <div className="contact--location__map--menu__item">
              <input
                type="radio"
                ...
                className="contact--location__map--menu__item--input"
              />
              <label htmlFor="streets-v11" className="contact--location__map--menu__item--input">Streets</label>
            </div>
            <div className="contact--location__map--menu__item">
              <input
                type="radio"
                ...
                className="contact--location__map--menu__item--input"
              />
              <label htmlFor="outdoors-v11" className="contact--location__map--menu__item--input">Outdoors</label>
            </div>
            <div className="contact--location__map--menu__item">
              <input
                type="radio"
                ...
                className="contact--location__map--menu__item--input"
              />
              <label htmlFor="satellite-v9" className="contact--location__map--menu__item--input">Satellite</label>
            </div>
            <div className="contact--location__map--menu__item">
              <input
                type="radio"
                ...
                className="contact--location__map--menu__item--input"
              />
              <label htmlFor="navigation-day-v1" className="contact--location__map--menu__item--input">Navigation Day</label>
            </div>
            <div className="contact--location__map--menu__item">
              <input
                type="radio"
                ...
                className="contact--location__map--menu__item--input"
              />
              <label htmlFor="navigation-night-v1" className="contact--location__map--menu__item--label">Navigation Night</label>
            </div>
          </div>
          {/* <div ref={mapContainer} id="map" style={{ height: "400px" }} /> */}
