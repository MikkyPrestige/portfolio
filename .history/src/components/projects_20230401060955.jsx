      ...
      <div className="project margin-top-5">
        ...
        <div className="project--wrapper">
          <div className="project--card">
            <div className="project--card__bg--img">
            <div className="project--card__bg--img project--card__img-15"></div>
            </div>
            ...
            <div className="project--card__content">
              ...
              <p className="project--card__content__desc">
                This is a tip calculator that calculates the correct tip amount
                and total bill amount per person based on the values entered by
                the user. It has a "Custom" button where you can enter a
                specific tip percentage. The calculator also includes a reset
                button and input validation to ensure that the number of people
                entered is not zero. This is a solution to the "tip calculator"
            ...
            <div className="project--card__links">
              ...
              <Link
                to={{ pathname: "https://mikky-tip-calculator.vercel.app/" }}
                target="_blank"
          ...
          <div className="project--card">
            <div className="project--card__bg--img">
            <div className="project--card__bg--img project--card__img-1"></div>
            </div>
            <div className="project--card__frame">
              <span className="project--card__frame__item">Css</span>
            ...
            <div className="project--card__content">
              ...
              <p className="project--card__content__desc">
                ...
                interface allows users to easily view all of their repositories
                in one place, including details such as name, description, and
                star rating. It was one of the projects for the AltSchool Africa
                School of Engineering Examination in the second semester.
              </p>
            </div>
            <div className="project--card__links">
              <Link
          ...
          <div className="project--card">
          <div className="project--card__bg--img">
            <div className="project--card__bg--img project--card__img-2"></div>
            </div>
            <div className="project--card__frame">
              <span className="project--card__frame__item">Html</span>
              <span className="project--card__frame__item">Css</span>
            ...
            <div className="project--card__content">
              ...
              <p className="project--card__content__desc">
                ...
                team "Phantom_Devz" that determines the telecom carrier based on
                a phone number entered by the user. <br /> It is one of the
                projects featured in the AltSchool Africa School of Engineering
                Holiday Hackathon in August '22.
              </p>
            </div>
            <div className="project--card__links">
              <Link
          ...
          <div className="project--card">
          <div className="project--card__bg--img">
            <div className="project--card__bg--img project--card__img-3"></div>
            </div>
            <div className="project--card__frame">
              <span className="project--card__frame__item">Css</span>
              <span className="project--card__frame__item">React</span>
          ...
          <div className="project--card">
          <div className="project--card__bg--img">
            <div className="project--card__bg--img project--card__img-4"></div>
            </div>
            <div className="project--card__frame">
          ...
          <div className="project--card">
          <div className="project--card__bg--img">
            <div className="project--card__bg--img project--card__img-5"></div>
            </div>
            <div className="project--card__frame">
              <span className="project--card__frame__item">Html</span>
              <span className="project--card__frame__item">CSS</span>
          ...
          <div className="project--card">
          <div className="project--card__bg--img">
            <div className="project--card__bg--img project--card__img-6"></div>
            </div>
            <div className="project--card__frame">
              <span className="project--card__frame__item">Html</span>
              <span className="project--card__frame__item">CSS</span>
          ...
          <div className="project--card">
          <div className="project--card__bg--img">
            <div className="project--card__bg--img project--card__img-7"></div>
            </div>
            <div className="project--card__frame">
              <span className="project--card__frame__item">Html</span>
              <span className="project--card__frame__item">CSS</span>
          ...
          <div className="project--card">
          <div className="project--card__bg--img">
            <div className="project--card__bg--img project--card__img-8"></div>
            </div>
            <div className="project--card__frame">
              <span className="project--card__frame__item">Css</span>
              <span className="project--card__frame__item">React</span>
          ...
          <div className="project--card">
          <div className="project--card__bg--img">
            <div className="project--card__bg--img project--card__img-9"></div>
            </div>
            <div className="project--card__frame">
              <span className="project--card__frame__item">Css</span>
              <span className="project--card__frame__item">React</span>
          ...
          <div className="project--card">
          <div className="project--card__bg--img">
            <div className="project--card__bg--img project--card__img-10"></div>
            </div>
            <div className="project--card__frame">
              <span className="project--card__frame__item">Html</span>
              <span className="project--card__frame__item">CSS</span>
          ...
          <div className="project--card">
          <div className="project--card__bg--img">
            <div className="project--card__bg--img project--card__img-11"></div>
            </div>
            <div className="project--card__frame">
              <span className="project--card__frame__item">Html</span>
              <span className="project--card__frame__item">CSS</span>
            ...
            <div className="project--card__content">
              ...
              <p className="project--card__content__desc">
                This Landing page was a code along project on 'Learn HTML & CSS
                in 2022 crash course' by Design Course on Udemy. Sass was also
                used but only for the Nesting feature.
              </p>
            </div>
            <div className="project--card__links">
              <Link
          ...
          <div className="project--card">
          <div className="project--card__bg--img">
            <div className="project--card__bg--img project--card__img-12"></div>
            </div>
            <div className="project--card__frame">
              <span className="project--card__frame__item">Html</span>
              <span className="project--card__frame__item">CSS</span>
          ...
          <div className="project--card">
          <div className="project--card__bg--img">
            <div className="project--card__bg--img project--card__img-13"></div>
            </div>
            <div className="project--card__frame">
              <span className="project--card__frame__item">Html</span>
              <span className="project--card__frame__item">CSS</span>
          ...
          <div className="project--card">
          <div className="project--card__bg--img">
            <div className="project--card__bg--img project--card__img-14"></div>
            </div>
            <div className="project--card__frame">
              <span className="project--card__frame__item">Html</span>
              <span className="project--card__frame__item">CSS</span>
