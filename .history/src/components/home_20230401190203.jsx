...
const Home = () => {
  const commentBg = 'let button_menu = document.querySelector(".header_button");
  ...
  const comment = `// Path: src\components\home.jsx
        ...
        <div className="home--contents">
          <div className="home--contents__wrapper">
            ...
            <div className="home--contents__content2">
              ...
              <div className="home--contents__content2--illustration__avatar">
                <Avatar
                  image={WebDeveloper}
              ...
              <p className="home--contents__content2--illustration__text">
