          ...
          <div className="project--grid__content">
            <div className="project--grid__content__wrapper">
              <div className="project--grid__content__card">
                ...
                <div className="project--content__card__links">
                  <Link
                    to={{
                      pathname:
                    ...
                    target="_blank"
                    className="project--content__card__links__link github-link-bg"
                  >
                  ...
                  <Link
                    ...
                    target="_blank"
                    className="project--content__card__links__link live-link-bg blue-markup"
                  >
              ...
              <div className="project--content__card">
                <div className="project--content__card__bg">
                  <div className="project--content__card__bg--img project--content__card__bg--img-1"></div>
                </div>
                <div className="project--content__card__frame">
                  <span className="project--content__card__frame__item">Css</span>
                  <span className="project--content__card__frame__item">React</span>
                </div>
                <div className="project--content__card__content">
                  <h2 className="project--content__card__content__title margin-top">
                    GitHub Repository App
                  </h2>
                  <p className="project--content__card__content__decontent__sc">
              ...
              <div className="project--content__card">
                <div className="project--content__card__bg">
                  <div className="project--content__card__bg--img project--content__card__bg--img-2"></div>
                </div>
                <div className="project--content__card__frame">
                  <span className="project--content__card__frame__item">Html</span>
                  <span className="project--content__card__frame__item">Css</span>
                  <span className="project--content__card__frame__item">JavaScript</span>
                </div>
                <div className="project--content__card__content">
                  <h2 className="project--content__card__content__title margin-top">
                    Phonie App
                  </h2>
                  <p className="project--content__card__content__desc">
              ...
              <div className="project--content__card">
                <div className="project--content__card__bg">
                  <div className="project--content__card__bg--img project--content__card__bg--img-3"></div>
                </div>
                <div className="project--content__card__frame">
                  <span className="project--content__card__frame__item">Css</span>
                  <span className="project--content__card__frame__item">React</span>
                  <span className="project--content__card__frame__item">Firebase</span>
                </div>
                <div className="project--content__card__content">
                  <h2 className="project--content__card__content__title margin-top">
                    RandomPeopleApp
