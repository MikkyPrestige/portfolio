        ...
        <div className="home--media__frame">
          {/* <div className="home--media__frame__github"> */}
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              className="home--media__frame__github"
            >
              <Avatar
                image={GitHub}
                alt="GitHub Icon"
                style={{ width: "2rem", height: "2rem", borderRadius: "50%", backgroundColor: "rgba(240, 227, 202, 1)", border: "1px solid #ededed" }}
              />
            </Link>
          {/* </div> */}
      ...
      <div className="home--contents">
        ...
        <div className="home--avatar">
          <Avatar
            ...
            style={{ width: "100%", height: "100%", borderRadius: "50%", backgroundColor: "rgba(240, 227, 202, 1)", border: "1px solid #ededed" }}
          />
        </div>
