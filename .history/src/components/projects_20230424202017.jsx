            ...
            <div className="project--card">
              ...
              <article className="project--card__side project--card__side__back">
                <div className="project--card__content">
                  ...
                  <p className="project--card__content__desc">
                  The task tracker is a web application that was part of a group project for the ongoing <mark>LightHall Internship competition.</mark> As a frontend developer, I focused on building the task manager page that users interact with after logging in. The app was built with React for the frontend, and Node.js & MongoDB for the backend and database.
                  The task manager allows users to perform a range of actions such as creating, editing, and deleting tasks, as well as sorting them by various criteria like title, status, and due date. I was responsible for implementing the logic for these actions. Overall, I am happy about this project because it showcased my proficiency in web development, React, and working collaboratively with a team.
                  </p>
                </div>
                <div className="project--card__links">
                  <Link
