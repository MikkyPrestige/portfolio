            ...
            <div className="project--wrapper">
              ...
              <div className="project--card">
                ...
                <div className="project--card__content">
                  ...
                  <p className="project--card__content__desc">
                  The survey form requires users to enter their name, email, and a number within a specific range. Incorrectly formatted inputs will trigger HTML5 validation errors. The form also includes a select dropdown, radio buttons, checkboxes, and a textarea for additional comments. A submit button is included to submit all the inputs. Each input field has corresponding label elements and placeholder text to guide users.
                    This is the solution to the Frontend Mentor Challenge's
                    'Fylo data storage component'.
                  </p>
                </div>
