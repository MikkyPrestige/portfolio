  ...
  return (
    <main className="app">
      <Helmet>
        ...
        I am a motivated and passionate frontend developer currently pursuing a diploma in Software Engineering at AltSchool Africa. I am eager to continue my education and apply my knowledge in a professional setting. As an intern or entry-level developer, I am dedicated to delivering high-quality code and building beautiful, intuitive user experiences." />
      </Helmet>
      <div
        sx={{
