      ...
      <div className="project--wrapper">
        ...
        <div className="project--card">
          ...
          <div className="project--card__content">
            ...
            <p className="project--card__content__desc">
            An interactive rating component built with HTML, CSS, and JavaScript. This innovative tool allows users to rate any item or service using a customizable star-based system.
            </p>
          </div>
          <div className="project--card__links">
            <Link
