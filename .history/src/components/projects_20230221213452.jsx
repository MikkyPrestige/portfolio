      ...
      <div className="project--wrapper">
        ...
        <div className="project--card">
          ...
          <div className="project--card__content">
            ...
            <p className="project--card__content__desc">
            This is a solution to the Interactive Rating Component built with HTML, CSS, and JavaScript. This is a small project to practice handling user interactions and updating the DOM.
            </p>
          </div>
          <div className="project--card__links">
            <Link
