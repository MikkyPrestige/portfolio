    ...
    <div className="project margin-top-5">
      ...
      <div className="project--wrapper">
        <div className="project--card">
          <div className="project--card__img project--card__img-1">
            {/* <Avatar image={RepoApp} alt="Repo App" className="project--card__img" /> */}
        </div>
          ...
          <div className="project--card__links margin-top">
          <Link
              to={{
                pathname:
