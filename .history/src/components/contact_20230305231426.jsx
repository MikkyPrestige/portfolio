...
mapboxgl.accessToken = 'pk.eyJ1IjoibWlra3lsYW5reSIsImEiOiJjbGV2dzJkYmsyNGNtM3JwNHQwM2JhZW54In0.lnfhNIrn8tfvMUYXyCFOGA';
    ...
    <div className="contact" id="contact">
      ...
      <div className="contact--location margin-top">
        ...
        <div className="contact--location__map">
          <div ref={mapContainer} className="mapContainer" setLat="6.1859" setLng="6.695894" zoom="8" />
          {/* <ReactMapGL
            {...viewport}
            width="100%"
            height="20rem"
            ...
            mapboxApiAccessToken={"pk.eyJ1IjoibWlra3lsYW5reSIsImEiOiJjbGV2dzJkYmsyNGNtM3JwNHQwM2JhZW54In0.lnfhNIrn8tfvMUYXyCFOGA"}
          /> */}
          {/* <iframe
            ...
            // allowfullscreen=""
            loading="lazy"
            className="contact--location__map--iframe"
          ></iframe> */}
        </div>
      </div>
    </div>
