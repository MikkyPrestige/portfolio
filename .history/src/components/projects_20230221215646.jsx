        ...
        <div className="project--card">
          ...
          <div className="project--card__content">
            ...
            <p className="project--card__content__desc">
              ...
              phone number entered by the user. <br /> It is one of the projects featured in the AltSchool Africa School of Engineering Holiday Hackathon in August '22. It was built with HTML, 
            </p>
          </div>
          <div className="project--card__links">
            <Link
