      ...
      <div className="home">
        ...
        <div className="home--contents">
          <div className="home--contents__wrapper">
            ...
            <div className="home--contents__content2">
              <div className="home--contents__content2--illustration">
                <div className="home--contents__content2--illustration__wrapper">
                <div className="home--contents__content2--illustration__wrapper--avatar">
                  <Avatar
                    image={WebDeveloper}
              ...
              <div className="home--contents__content2--illustration__overlay home--contents__content2--illustration__overlay-1"></div>
              <div className="home--contents__content2--illustration__overlay home--contents__content2--illustration__overlay-2"></div>
                  </div>
                <pre className="home--contents__content2--illustration__text">{codeSnippet}</pre>
              </div>
              <figure className="home--contents__content2__quote">
                <blockquote
                  className="home--contents__content2__quote__block"
                ...
                >
                  <p className="home--contents__content2__quote__block__text">
                    The best way to predict the future is to invent it.
                  </p>
                </blockquote>
                <figcaption className="home--contents__content2__quote__block__caption">
                  — Alan Kay
                  <cite>
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="home--contents__content2__quote__block__caption__cite"
                    >
          ...
          <div className="home--contents__slides">
            <ProjectSlide />
          </div>
        </div>
      </div>
