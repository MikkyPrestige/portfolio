            ...
            <div className="project--card">
              ...
              <article className="project--card__side project--card__side__back">
                <div className="project--card__content">
                  ...
                  <p className="project--card__content__desc">
                    The task tracker is a simple web application built with React for the frontend and NodeJs & MongoDB for the backend and database. It allows users to create, edit, and delete tasks, as well as view and sort them by different criteria such as title, status, and due date.
                    The app is part of the group projects to be built for <strong>LightHall Internship competition which is still ongoing</strong>. I worked on the frontend part which is the task manager page a user sees after login and so i  implemented the logics to add, edit, delete, save tasks as well as the sorting functionalities.
                  </p>
                </div>
                <div className="project--card__links">
                  <Link
