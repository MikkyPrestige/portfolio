    ...
    <div className="project--wrapper">
      ...
      <div className="project--card">
        ...
        <div className="project--card__content">
          ...
          <p className="project--card__content__desc">
          The Phonie Project is a web-based application created by the team "Phantom_Devz" that can easily identify the telecoms carrier from a phone number inputed by the user.
    </div>
  </div>
  );
};
