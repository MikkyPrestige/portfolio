            ...
            <div className="about--skills__content__items">
              <div className="about--skills__content__items__card">
                <div className="about--skills__content__items__card__icon">
                  <Avatar image={HTML5} alt="html5" style={{ width: "5rem", height: "5rem"}} />
              ...
              <div className="about--skills__content__items__card">
                <div className="about--skills__content__items__card__icon">
                  <Avatar image={CSS3} alt="css3" style={{ width: "5rem", height: "5rem"}} />
              ...
              <div className="about--skills__content__items__card">
                <div className="about--skills__content__items__card__icon">
                  <Avatar image={SASS} alt="sass" style={{ width: "5rem", height: "5rem"}} />
              ...
              <div className="about--skills__content__items__card">
                <div className="about--skills__content__items__card__icon">
                  <Avatar image={JS} alt="javascript" style={{ width: "5rem", height: "5rem"}} />
              ...
              <div className="about--skills__content__items__card">
                <div className="about--skills__content__items__card__icon">
                  <Avatar image={GIT} alt="git" style={{ width: "5rem", height: "5rem"}} />
              ...
              <div className="about--skills__content__items__card">
                <div className="about--skills__content__items__card__icon">
                  <Avatar image={REACT} alt="react" style={{ width: "5rem", height: "5rem"}} />
              ...
              <div className="about--skills__content__items__card">
                <div className="about--skills__content__items__card__icon">
                  <Avatar image={VUE} alt="vue" style={{ width: "5rem", height: "5rem"}} />
              ...
              <div className="about--skills__content__items__card">
                <div className="about--skills__content__items__card__icon">
                  <Avatar image={FIGMA} alt="figma" style={{ width: "5rem", height: "5rem"}} />
