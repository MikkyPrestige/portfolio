        ...
        <div className="project--card">
          ...
          <div className="project--card__content">
            ...
            <p className="project--card__content__desc">
              ...
              and total bill amount per person based on the bill amount and tip percentage
              entered by the user. It has a "Custom" button where you can enter
              a specific tip percentage. The calculator also includes a reset
