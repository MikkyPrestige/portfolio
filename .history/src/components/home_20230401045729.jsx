      ...
      <div className="home">
        ...
        <div className="home--contents">
          ...
          <div className="home--content2">
            <div className="home--content2__avatar">
              <Avatar
                image={WebDeveloper}
            ...
            <figure className="home--content2__quote">
              <blockquote
                className="home--content2__quote__block"
              ...
              >
                <p className="home--content2__quote__block__text">
                  The best way to predict the future is to invent it.
                </p>
              </blockquote>
              <figcaption className="home--content2__quote__block__caption">
                — Alan Kay
                <cite>
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="home--content2__quote__block__caption__cite"
                  >
