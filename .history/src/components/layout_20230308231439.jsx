        ...
        <div className="layout--header__title">
          <div className="layout--header__title__content">
            <span className="layout--header__title__content__span">
              <Avatar image={LessThan} alt="Less Than Icon" style={{ width: "1.5rem", height: "1.5rem"}} />
            </span>
            ...
            <span className="layout--header__title__content__span">
              <Avatar image={Line} alt="Line Icon" style={{ width: "1.5rem", height: "1.5rem", backgroundColor: "var(--color--bg-dark-2)"}} />
            </span>
            <span className="layout--header__title__content__span">
              <Avatar image={MoreThan} alt="More Than Icon" style={{ width: "1.5rem", height: "1.5rem"}} />
            </span>
          </div>
        </div>
