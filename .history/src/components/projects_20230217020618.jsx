                                      ...
                                      <Link
                                        ...
                                        <div className="project--card">
                                          ...
                                          <div className="project--card__content">
                                            ...
                                            <p className="project--card__content__desc">
                                              This is a layout for a fictional company called Flyo. It was built with HTML and Css
                                              </p>
                                              </div>
                                              <div className="project--card__links">
                                                <Link
                                                  ...
                                                  <div className="project--card">
                                                    ...
                                                    <div className="project--card__content">
                                                      ...
                                                      <p className="project--card__content__desc">
                                                        ...
                                                        <div className="project--card__links">
                                                          <Link
                                                            to={{ pathname: "https://github.com/MeekyBerry/Frontend-Mentor-challenges/tree/main/order-summary-card-component" }}
                                                            target="_blank"
                                                            className="project--card__links__link"
                                                            >
                                                              View on GitHub
                                                            ...
                                                            <Link
                                                              to={{ pathname: "https://order-summary-card-project.netlify.app/" }}
                                                              target="_blank"
                                                              className="project--card__links__link"
                                                              >
                                                                View Live
                                                              ...
                                                              <div className="project--card">
                                                                ...
                                                                <div className="project--card__content">
                                                                  ...
                                                                  <p className="project--card__content__desc">
                                                                    ...
                                                                    <div className="project--card__links">
                                                                      <Link
                                                                        to={{ pathname: "https://github.com/MeekyBerry/Frontend-Mentor-challenges/tree/main/stats-preview-card-compo" }}
                                                                        target="_blank"
                                                                        className="project--card__links__link"
                                                                        >
                                                                          View on GitHub
                                                                        ...
                                                                        <Link
                                                                          to={{ pathname: "https://stats-preview-card-project.netlify.app/" }}
                                                                          target="_blank"
                                                                          className="project--card__links__link"
                                                                          >
                                                                            View Live
