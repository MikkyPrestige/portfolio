      ...
      <div className="project--wrapper">
        ...
        <div className="project--card">
          ...
          <div className="project--card__content">
            ...
            <p className="project--card__content__desc">
            A visually stunning chat app illustration built with CSS and HTML from Frontend Mentor Challenge. This innovative illustration showcases a beautifully designed chat app interface that is sure to capture the attention of users.
            </p>
          </div>
          <div className="project--card__links">
            <Link
