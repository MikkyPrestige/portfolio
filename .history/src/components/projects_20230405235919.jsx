            ...
            <div className="project--wrapper">
              ...
              <div className="project--card">
                ...
                <div className="project--card__content">
                  ...
                  <p className="project--card__content__desc">
                  For the 'Responsive Web Design' certification projects on freeCodeCamp, I built this CSS documentation app because i really found CSS interesting when i started my development journey
                  </p>
                </div>
                <div className="project--card__links">
                  <Link
