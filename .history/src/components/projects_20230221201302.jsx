      ...
      <div className="project--wrapper">
        ...
        <div className="project--card">
          ...
          <div className="project--card__content">
            ...
            <p className="project--card__content__desc">
            An interactive rating component built with HTML, CSS, and JavaScript. This is a small project to practice handling user interactions and updating the DOM.
            </p>
          </div>
          <div className="project--card__links">
            <Link
        ...
        <div className="project--card">
          ...
          <div className="project--card__content">
            ...
            <p className="project--card__content__desc">
            This is a powerful calculator that can perform high-level functions. Built with a sleek, user-friendly interface and advanced mathematical algorithms, this calculator is perfect for anyone who needs to perform complex calculations quickly and efficiently.
