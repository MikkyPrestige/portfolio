      ...
      <div className="project--wrapper">
        <div className="project--card">
          ...
          <div className="project--card__content">
            ...
            React-based web app that utilizes the GitHub API to showcase a user's repositories. With its sleek and intuitive interface, this app allows users to easily view all of their repositories in one place, including details such as the name, description, and number of stars.
            </p>
          </div>
