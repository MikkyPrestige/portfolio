            ...
            <div className="project--wrapper">
              ...
              <div className="project--card">
                ...
                <div className="project--card__content">
                  ...
                  <p className="project--card__content__desc">
                  The survey form app collects name, email, a number within a range, a select dropdown, radio buttons, checkboxes, and a textarea for comments. It includes validation and placeholder text. Users submit their inputs with a submit button.
                    This was part of projects i built to pass the 'Responsive Web Design' certification on freeCodeCamp.
                  </p>
                </div>
                <div className="project--card__links">
                  <Link
