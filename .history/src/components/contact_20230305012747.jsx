        ...
        <div className="contact--content__right">
          ...
          <div className="contact--content__right__links">
            <p className="contact--content__right__links__item">
              <Avatar image={Phone} alt="Phone Icon" style={{ width: "5rem", height: "5rem" }} />
              <a
              href="tel: 08030849685"
              // className="contact--content__right__links__item"
            >
              +2348030849685
            </a>
            </p>
            <p className="contact--content__right__links__item">
              <Avatar image={Gmail} alt="Gmail Icon" style={{ width: "5rem", height: "5rem" }} />
              <a
