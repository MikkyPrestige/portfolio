...
from,
  ...
  22.2% {
    -webkit-transform: skewX(-11.5deg) skewY(-11.5deg);
    transform: skewX(-11.5deg) skewY(-11.5deg);
  }

  33.3% {
    -webkit-transform: skewX(5.25deg) skewY(5.25deg);
    transform: skewX(5.25deg) skewY(5.25deg);
  }
