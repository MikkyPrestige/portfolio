      ...
      <div className="home">
        ...
        <div className="home--contents">
          <div className="home--contents__wrapper">
            <JackInTheBox duration={5000} className="home--contents__content">
              <div>
            ...
            <Reveal
              ...
              duration={5000}
              className="home--contents__illustration"
            >
              <div>
          ...
          {/* <Fade direction="up" duration={5000} className="home--slides"> */}
          <Reveal keyframes={fadeInUp} duration={5000} className="home--slides">
          <div>
            <ProjectSlide />
          </div>
          </Reveal>
