        ...
        <div className="home--contents">
          <div className="home--contents__wrapper">
            ...
            <div className="home--contents__content2">
              ...
              <div className="home--contents__content2--illustration__wrapper--overlay home--contents__content2--illustration__wrapper--overlay-1"></div>
              {/* <div className="home--contents__content2--illustration__wrapper--overlay home--contents__content2--illustration__wrapper--overlay-2"></div> */}
                  </div>
