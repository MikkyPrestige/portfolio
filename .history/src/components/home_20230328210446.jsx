      ...
      <div className="home--contents">
        <div className="home--content">
          ...
          <div className="home--content__btn">
            <Link to="https://www.canva.com/design/DAFdxBFz6mg/Sr0P3VS0WESZ7iLlzw7JIw/view?utm_content=DAFdxBFz6mg&utm_campaign=designshare&utm_medium=link&utm_source=publishsharelink#1"
              target="_blank"
              download
            >
              <button className="home--content__btn__resume">Resume</button>
            </Link>
