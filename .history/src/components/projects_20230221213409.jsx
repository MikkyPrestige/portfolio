      ...
      <div className="project--wrapper">
        ...
        <div className="project--card">
          ...
          <div className="project--card__content">
            ...
            <p className="project--card__content__desc">
            This is An interactive rating component built with HTML, CSS, and JavaScript. This is a small project to practice handling user interactions and updating the DOM.
            </p>
          </div>
          <div className="project--card__links">
            <Link
