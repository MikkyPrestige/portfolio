          ...
          <div className="about--skills__title">
            <h1 className="about--skills__title__head">
              ...
              <span className="about--skills__title__icon">
                <Avatar image={Skills} alt="skills" style={{ width: "3rem", height: "3rem"}}/>
            ...
            <div className="about--skills__content__items">
              <div className="about--skills__content__items__card">
                <div className="about--skills__content__items__card__icon">
                  <Avatar image={HTML5} alt="html5" style={{ width: "3rem", height: "3rem"}} />
              ...
              <div className="about--skills__content__items__card">
                <div className="about--skills__content__items__card__icon">
                  <Avatar image={CSS3} alt="css3" style={{ width: "3rem", height: "3rem"}} />
              ...
              <div className="about--skills__content__items__card">
                <div className="about--skills__content__items__card__icon">
                  <Avatar image={SASS} alt="sass" style={{ width: "3rem", height: "3rem"}} />
              ...
              <div className="about--skills__content__items__card">
                <div className="about--skills__content__items__card__icon">
                  <Avatar image={JS} alt="javascript" style={{ width: "3rem", height: "3rem"}} />
              ...
              <div className="about--skills__content__items__card">
                <div className="about--skills__content__items__card__icon">
                  <Avatar image={GIT} alt="git" style={{ width: "3rem", height: "3rem"}} />
              ...
              <div className="about--skills__content__items__card">
                <div className="about--skills__content__items__card__icon">
                  <Avatar image={REACT} alt="react" style={{ width: "3rem", height: "3rem"}} />
              ...
              <div className="about--skills__content__items__card">
                <div className="about--skills__content__items__card__icon">
                  <Avatar image={VUE} alt="vue" style={{ width: "3rem", height: "3rem"}} />
              ...
              <div className="about--skills__content__items__card">
                <div className="about--skills__content__items__card__icon">
                  <Avatar image={FIGMA} alt="figma" style={{ width: "3rem", height: "3rem"}} />
