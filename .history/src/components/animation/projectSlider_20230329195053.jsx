      ...
      {projects.length > 1 && (
        <div className="projectSlider--pagination">
          {projects.map((project, index) => (
            ...
            >
              {isHovered && (
                // Display toolip for the particular dot hover one
                <div className="projectSlider--pagination__dot--tooltip">
                  <img
                    src={project.image}
                    alt={project.title}
                    className="projectSlider--pagination__dot--tooltip--img"
                  />
                  <p className="projectSlider--pagination__dot--tooltip--title">
                    {project.title}
                  </p>
                </div>
                 )}
