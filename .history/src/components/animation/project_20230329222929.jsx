...
const ProjectSlide = () => {
  ...
  return (
      <div className="project--slider">
        ...
        <h1 className="project--slider__wrapper__head"><span className="project--slider__wrapper__head--span">#</span>Projects <span className="project--slider__wrapper__head--line">{""}</span></h1>
        <p className="project--slider__wrapper__view">
          <Link
            to="/projects"
            className="project--slider__wrapper__view--link"
          >
            View all
