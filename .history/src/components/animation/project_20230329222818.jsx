...
const ProjectSlide = () => {
  ...
  return (
      <div className="project--slider">
        ...
        <h1 className="project--slider__head"><span className="project--slider__wrapper__head--span">#</span>Projects <span className="project--slider__wrapper__line"></span></h1>
