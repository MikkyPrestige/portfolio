  ...
  return (
    <div className="projectSlider">
      ...
      <div className="projectSlider--controls">
        ...
        >
          <img src={Backward} alt="Backward Icon" className="projectSlider--controls__btn--img"  />
               </button>
        <button
        ...
        >
          {isPlaying ? (
            <img src={Pause} alt="Pause Icon" className="projectSlider--controls__btn--img" />
          ) : (
            <img src={Play} alt="Play Icon" className="projectSlider--controls__btn--img"/>
          )}
        </button>
        <button
          className="projectSlider--controls__btn"
        ...
        >
          <img src={Forward} alt="Forward Icon" className="projectSlider--controls__btn--img"  />
        </button>
      </div>
      {projects.length > 1 && (
