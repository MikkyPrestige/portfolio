...
const Project = [
  {
    title: "Phonie App",
    description: "A web-based application created by the team 'Phantom_Devz' that determines the telecom carrier based on a phone number entered by the user.",
    image: Phonie,
    link: "https://phonie-app.netlify.app/",
  },
  {
    title: "Tip Calculator",
    description: "A simple tip calculator that calculates the tip amount and total bill amount based on the bill amount and tip percentage entered by the user.",
    image: TipCalculator,
  ...
  return (
    <div className="project">
      ...
      <div className="project--slider__container">
        <div className="project--slider__container__slider">
          <Slider
            slides={Project}
            onMoveNextSlide={handleNextSlide}
            onMovePrevSlide={handlePreviousSlide}
          />
      </div>
    </div>
    </div>
