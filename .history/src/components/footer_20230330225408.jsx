          ...
          <div className="footer--container__content__contact">
            ...
            <div className="footer--container__content__contact--media">
              ...
              <div className="footer--container__content__contact--media--links">
                ...
                >
                  <Avatar image={Github} alt="GitHub Icon" style={{ width: "100%", height: "100%" }} />
                </a>
                <a href="https://www.linkedin.com/in/mikkylanky/"
                  className="footer--container__content__contact--media--links--link"
                >
                  <Avatar image={Linkedin} alt="GitHub Icon" style={{ width: "100%", height: "100%" }} />
                </a>
                <a
                href="https://discordapp.com/users/786382582220193803"
                  className="footer--container__content__contact--media--links--link"
                >
                  <Avatar image={Discord} alt="GitHub Icon" style={{ width: "100%", height: "100%" }} />
                </a>
                <a
                  href="https://meekyberry.hashnode.dev/"
                  className="footer--container__content__contact--media--links--link"
                >
                  <Avatar image={Twitter} alt="GitHub Icon" style={{ width: "100%", height: "100%" }} />
                </a>
            </div>
            </div>
          </div>
