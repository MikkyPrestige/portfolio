    ...
    <div className="contact" id="contact">
      ...
      <div className="contact--content">
        ...
        <div className="contact--content__right">
          ...
          <div className="contact--content__right__links">
              <a href="tel: 08030849685" className="contact--content__right__links__item">+2348030849685</a>
              <a href="mailto: michaelelue117@gmail.com" className="contact--content__right__links__item">
      ...
      <div className="contact--location">
        ...
        <span className="contact--location__title__icon">
          <Avatar image={Location} alt="Location icon" style={{ width: "5rem", height: "5rem"}} />
          </span>
        </div>
