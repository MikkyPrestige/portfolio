  ...
  return (
    <div className="layout layout--large">
      <header className="layout--large__header">
        <div className="layout--large__title">
          <h1 className="layout--large__title__content">
            <span className="layout--large__title__content__span">{"<"}</span>
            <span className="layout--large__header__title__content__span--2">
              ELUE
            </span>
            MICHAEL<span className="layout--large__title__content__span">{"/>"}</span>
          </h1>
        </div>
        <div className="layout--large__menu">
          <ul className="layout--large__menu__list">
            <li className="layout--large__menu__list__item">
