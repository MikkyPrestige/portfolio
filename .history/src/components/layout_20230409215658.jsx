      ...
      <header className="layout--header">
        ...
        <nav className="layout--nav">
          <button className="layout--nav__button" onClick={toggleMenu}>
            {showMenu ? <MdClose style={{ width: "3rem", height: "3rem", color: "#228be6" }} /> : <FiMenu style={{ width: "3rem", height: "3rem", color: "#228be6" }} />}
          </button>
          <div className={`layout--nav__content ${showMenu ? "show" : ""}`}>
            <ul className="layout--nav__content__list">
              <li>
                ...
                >
                  <TbSmartHome style={{ width: "4rem", height: "4rem", color: "#228be6" }} />
                  Home
                </CustomNavLink>
              </li>
              <li>
                <CustomNavLink
                  ...
                  className="layout--nav__content__list__item"
                >
                  <BiCodeAlt style={{ width: "4rem", height: "4rem", color: "#228be6"  }} />
                  Skills
                </CustomNavLink>
              </li>
              <li>
                <CustomNavLink
                  ...
                  className="layout--nav__content__list__item"
                >
                  <FcWorkflow style={{ width: "4rem", height: "4rem" }} />
                  Projects
                </CustomNavLink>
              </li>
              <li>
                <CustomNavLink
                  ...
                  className="layout--nav__content__list__item"
                >
                  <FcCollaboration style={{ width: "4rem", height: "4rem" }} />
                  Contact
                </CustomNavLink>
              </li>
            </ul>
