      ...
      <div className="project--wrapper">
        <div className="project--card">
          ...
          <div className="project--card__content">
            ...
            This is a React-based web app that utilizes the GitHub API to showcase a user's repositories. With its sleek and intuitive interface, this app allows users to easily view all of their repositories in one place, including details such as the name, description, and number of stars. It was one of the projects for the second semester AltSchool Africa School of Engineering Examination.
            </p>
          </div>
        ...
        <div className="project--card">
          ...
          <div className="project--card__content">
            ...
            <p className="project--card__content__desc">
            This is a solution to the Interactive rating component on Frontend Mentor Challenge. This is a small project to practice handling user interactions and updating the DOM. built with HTML, CSS, and JavaScript.
            </p>
          </div>
          <div className="project--card__links">
            <Link
