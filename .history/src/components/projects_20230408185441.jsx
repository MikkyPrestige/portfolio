        ...
        <section className="project--wrapper">
            ...
            <div className="project--card">
              <div className="project--card__side project--card__side__front">
                <div className="project--card__side__bg">
                  <div className="project--card__side__bg--img project--card__side__bg--img-15"></div>
                </div>
          ...
          <Fade direction="left" duration={5000}>
            <div className="project--card">
              <div className="project--card__side project--card__side__front">
                <div className="project--card__side__bg">
                  <div className="project--card__side__bg--img project--card__side__bg--img-1"></div>
                </div>
                <div className="project--card__side__frame">
                  <span className="project--card__side__frame__item">Css</span>
          ...
          <Fade direction="left" duration={5000}>
            <div className="project--card">
              <div className="project--card__side project--card__side__front">
                <div className="project--card__side__bg">
                  <div className="project--card__side__bg--img project--card__bg--img-5"></div>
                </div>
                <div className="project--card__side__frame">
                  <span className="project--card__side__frame__item">Html</span>
                  <span className="project--card__side__frame__item">CSS</span>
          ...
          <Fade direction="right" duration={5000}>
            <div className="project--card">
              <div className="project--card__side project--card__side__front">
                <div className="project--card__side__bg">
                  <div className="project--card__side__bg--img project--card__bg--img-6"></div>
                </div>
                <div className="project--card__side__frame">
                  <span className="project--card__side__frame__item">Html</span>
                  <span className="project--card__side__frame__item">CSS</span>
              ...
              <div className="project--card__side__side project--card__side__back">
                <div className="project--card__side__content">
                  <h2 className="project--card__side__content__title margin-top">
          ...
          <Fade direction="left" duration={5000}>
            <div className="project--card">
              <div className="project--card__side project--card__side__front">
                <div className="project--card__side__bg">
                  <div className="project--card__side__bg--img project--card__bg--img-7"></div>
                </div>
                <div className="project--card__side__frame">
                  <span className="project--card__side__frame__item">Html</span>
                  <span className="project--card__side__frame__item">CSS</span>
          ...
          <Fade direction="right" duration={5000}>
            <div className="project--card">
              <div className="project--card__side project--card__side__front">
                <div className="project--card__side__bg">
                  <div className="project--card__side__bg--img project--card__bg--img-8"></div>
                </div>
                <div className="project--card__side__frame">
                  <span className="project--card__side__frame__item">Css</span>
                  <span className="project--card__side__frame__item">React</span>
          ...
          <Fade direction="left" duration={5000}>
            <div className="project--card">
              <div className="project--card__side project--card__side__front">
                <div className="project--card__side__bg">
                  <div className="project--card__side__bg--img project--card__bg--img-9"></div>
                </div>
                <div className="project--card__side__frame">
                  <span className="project--card__side__frame__item">Css</span>
                  <span className="project--card__side__frame__item">React</span>
          ...
          <Fade direction="right" duration={5000}>
            <div className="project--card">
              <div className="project--card__side project--card__side__front">
                <div className="project--card__side__bg">
                  <div className="project--card__side__bg--img project--card__bg--img-10"></div>
                </div>
                <div className="project--card__side__frame">
                  <span className="project--card__side__frame__item">Html</span>
                  <span className="project--card__side__frame__item">CSS</span>
          ...
          <Fade direction="left" duration={5000}>
            <div className="project--card">
              <div className="project--card__side project--card__side__front">
                <div className="project--card__side__bg">
                  <div className="project--card__side__bg--img project--card__bg--img-11"></div>
                </div>
                <div className="project--card__side__frame">
                  <span className="project--card__frame__side__item">Html</span>
                  <span className="project--card__frame__side__item">CSS</span>
                  <span className="project--card__frame__side__item">Sass</span>
                  <span className="project--card__frame__side__item">Javascript</span>
                </div>
              </div>
              <div className="project--card__side project--card__side__back">
                <div className="project--card__side__content">
          ...
          <Fade direction="right" duration={5000}>
            <div className="project--card">
              <div className="project--card__side project--card__side__front">
                <div className="project--card__side__bg">
                  <div className="project--card__side__bg--img project--card__bg--img-12"></div>
                </div>
                <div className="project--card__side__frame">
                  <span className="project--card__side__frame__item">Html</span>
                  <span className="project--card__side__frame__item">CSS</span>
          ...
          <Fade direction="left" duration={5000}>
            <div className="project--card">
              <div className="project--card__side project--card__side__front">
                <div className="project--card__side__bg">
                  <div className="project--card__side__bg--img project--card__bg--img-13"></div>
                </div>
                <div className="project--card__side__frame">
                  <span className="project--card__side__frame__item">Html</span>
                  <span className="project--card__side__frame__item">CSS</span>
          ...
          <Fade direction="right" duration={5000}>
            <div className="project--card">
              <div className="project--card__side project--card__side__front">
                <div className="project--card__side__bg">
                  <div className="project--card__side__bg--img project--card__bg--img-14"></div>
                </div>
                <div className="project--card__side__frame">
                  <span className="project--card__side__frame__item">Html</span>
                  <span className="project--card__side__frame__item">CSS</span>
          ...
          {/* <div className="project--card">
            <div className="project--card__side project--card__side__front">
                <div className="project--card__side__bg">
                  <div className="project--card__side__bg--img project--card__bg--img-16"></div>
                </div>
                <div className="project--card__side__frame">
                  <span className="project--card__side__frame__item">Html</span>
                  <span className="project--card__side__frame__item">CSS</span>
          ...
          <Fade direction="left" duration={5000}>
            <div className="project--card">
              <div className="project--card__side project--card__side__front">
                <div className="project--card__side__bg">
                  <div className="project--card__side__bg--img project--card__bg--img-17"></div>
                </div>
                <div className="project--card__side__frame">
                  <span className="project--card__side__frame__item">Html</span>
                  <span className="project--card__side__frame__item">CSS</span>
          ...
          {/* <div className="project--card">
                <div className="project--card__side__bg">
                  <div className="project--card__side__bg--img project--card__bg--img-19"></div>
                </div>
                <div className="project--card__side__frame">
                  <span className="project--card__side__frame__item">Html</span>
                  <span className="project--card__side__frame__item">CSS</span>
          ...
          <Fade direction="right" duration={5000}>
            <div className="project--card">
              <div className="project--card__side project--card__side__front">
                <div className="project--card__side__bg">
                  <div className="project--card__side__bg--img project--card__bg--img-20"></div>
                </div>
                <div className="project--card__side__frame">
                  <span className="project--card__side__frame__item">Html</span>
                  <span className="project--card__side__frame__item">CSS</span>
          ...
          <Fade direction="left" duration={5000}>
            <div className="project--card">
              <div className="project--card__side project--card__side__front">
                <div className="project--card__side__bg">
                  <div className="project--card__side__bg--img project--card__bg--img-21"></div>
                </div>
                <div className="project--card__side__frame">
                  <span className="project--card__side__frame__item">Html</span>
                  <span className="project--card__side__frame__item">CSS</span>
              ...
              <div className="project--card__side project--card__side__back">
                <div className="project--card__side__content">
                  ...
                  <p className="project--card__side__content__desc">Just for Fun.</p>
                </div>
                <div className="project--card__side__links">
                  <Link
                    to={{
          ...
          <Fade direction="right" duration={5000}>
            <div className="project--card">
              <div className="project--card__side project--card__side__front">
                <div className="project--card__side__bg">
                  <div className="project--card__side__bg--img project--card__bg--img-22"></div>
                </div>
                <div className="project--card__side__frame">
                  <span className="project--card__side__frame__item">Html</span>
                  <span className="project--card__side__frame__item">CSS</span>
