      ...
      <div className="form--success">
        {success && (
          <div className="form--success__popup">
            <div className="form--success__popup--avatar">
              <Avatar
                image={ThumbsUp}
                alt="Thumbs Up"
            ...
            <p className="form--success__popup--msg">
            Thank you <strong><em>{fullNameSuccess}</em></strong> for sending a message, I will get back to you as soon as possible.
          </p>
          <button onClick={removePopup} className="form--success__popup--btn">
            Got it!
          </button>
          </div>
        )}
