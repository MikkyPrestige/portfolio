            ...
            <div className="project--card">
              ...
              <article className="project--card__side project--card__side__back">
                <div className="project--card__content">
                  ...
                  <p className="project--card__content__desc">
                    The calculator is a simple web application and functional tool for performing mathematical operations. The
                    interface is sleek and user-friendly on desktop, and the mathematical algorithms are advanced.
                  </p>
                </div>
                <div className="project--card__links">
                  <Link
            ...
            <div className="project--card">
              ...
              <article className="project--card__side project--card__side__back">
                <div className="project--card__content">
                  ...
                  <p className="project--card__content__desc">
                    This is a solution to <mark>Frontend Mentor Challenge.</mark> In this project, I
                    re-created the visually stunning chat app CSS illustration created by Frontend Mentor from scratch to finish.
                  </p>
                </div>
                <div className="project--card__links">
                  <Link
            ...
            <div className="project--card">
              ...
              <article className="project--card__side project--card__side__back">
                <div className="project--card__content">
                  ...
                  <p className="project--card__content__desc">
                    This is a solution to the <mark>Frontend Mentor Challenge.</mark> It is a simple HTML and CSS based card
                    component.
                  </p>
                </div>
                <div className="project--card__links">
            ...
            <div className="project--card">
              ...
              <article className="project--card__side project--card__side__back">
                <div className="project--card__content">
                  ...
                  <p className="project--card__content__desc">
                    This is a solution to the <mark>Frontend Mentor Challenge.</mark> I worked on this project to
            ...
            <div className="project--card">
              ...
              <article className="project--card__side project--card__side__back">
                <div className="project--card__content">
                  ...
                  <p className="project--card__content__desc">
                    This is the solution to the <mark>Frontend Mentor Challenge.</mark>
                  </p>
                </div>
                <div className="project--card__links">
                  <Link
            ...
            <div className="project--card">
              ...
              <article className="project--card__side project--card__side__back">
                <div className="project--card__content">
                  ...
                  <p className="project--card__content__desc">
                   I created this tribute page to pay homage to
                    the legendary musician, <mark>Bob Marley</mark>. I hold Bob Marley in
                    high esteem and consider him to be the greatest musician of all time.
                  </p>
                </div>
                <div className="project--card__links">
                  <Link
