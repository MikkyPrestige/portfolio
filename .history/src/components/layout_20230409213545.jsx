          ...
          <div className={`layout--nav__content ${showMenu ? "show" : ""}`}>
            <ul className="layout--nav__content__list">
              <li>
                ...
                >
                  <TbSmartHome style={{ width: "4rem", height: "4rem" }} />
                  Home
                </CustomNavLink>
              </li>
              <li>
                <CustomNavLink
                  ...
                  className="layout--nav__content__list__item"
                >
                  <BiCodeAlt style={{ width: "4rem", height: "4rem" }} />
                  Skills
                </CustomNavLink>
              </li>
              <li>
                <CustomNavLink
                  ...
                  className="layout--nav__content__list__item"
                >
                  <FcWorkflow style={{ width: "4rem", height: "4rem", fill: "#228be6" }} />
                  Projects
                </CustomNavLink>
              </li>
              <li>
                <CustomNavLink
                  ...
                  className="layout--nav__content__list__item"
                >
                  <FcCollaboration style={{ width: "4rem", height: "4rem", backgroundColor: "#228be6" }} />
                  Contact
                </CustomNavLink>
              </li>
            </ul>
