            ...
            <div className="project--card">
              ...
              <article className="project--card__side project--card__side__back">
                <div className="project--card__content">
                  ...
                  <p className="project--card__content__desc">
                    This is a simple web tool for counting numbers. It stores the count value so that it is still available on page reload.
                    It was built with Vue and Scss. It was the third
