        ...
        <div className="about--skills">
          ...
          <div className="about--skills__content">
            <div className="about--skills__content__item">
              <div className="about--skills__content__item__card">
              <div className="about--skills__content__item__card__icon">
                <FaHtml5 style={{ color: "red"}} />
              </div>
              <div className="about--skills__content__item__card__text">
                <h2 className="about--skills__content__item__card__text__head">
                  HTML5
                </h2>
              </div>
              </div>
