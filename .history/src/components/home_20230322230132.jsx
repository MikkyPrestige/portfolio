      ...
      <div className="home--media">
        ...
        <div className="home--media__frame">
          <div className="home--media__frame__github">
            <Avatar image={GitHub} alt="GitHub icon" style={{ width: "3rem", height: "3rem", borderRadius: "5%" }} />
          </div>
          <div className="home--media__frame__leetCode">
            <Avatar image={LeetCode} alt="LeetCode icon" style={{ width: "3rem", height: "3rem", borderRadius: "5%" }} />
          </div>
          <div className="home--media__frame__LinkedIn">
            <Avatar image={LinkedIn} alt="LinkedIn icon" style={{ width: "3rem", height: "3rem", borderRadius: "5%" }} />
          </div>
        </div>
      </div>
