      ...
      <header className="layout--header">
        <div className="layout--header__title">
          <h1 className="layout--header__title__content">
            <span className="layout--header__title__content__span">{"<"}</span><span className="layout--header__title__name">ELUE</span>
            MICHAEL <span className="layout--header__title__content__span">{"/>"}</span>
          </h1>
        </div>
      ...
      <header className="layout--header">
        <div className="layout--title">
          <h1 className="layout--title__content">
            <span className="layout--title__content__span">{"<"}</span><span className="layout--header__title__name">ELUE</span>
