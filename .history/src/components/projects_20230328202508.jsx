        ...
        <div className="project--card">
          ...
          <div className="project--card__content">
            ...
            <p className="project--card__content__desc">
              ...
              entered by the user. It has a "Custom" button for entering a specific tip percentage.
              The calculator also has a reset button and input validation to ensure that input values for the number of people is not zero.
            </p>
          </div>
