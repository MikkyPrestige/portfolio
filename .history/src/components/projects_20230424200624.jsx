            ...
            <div className="project--card">
              ...
              <article className="project--card__side project--card__side__back">
                <div className="project--card__content">
                  ...
                  <p className="project--card__content__desc">
                    The task tracker is a simple web application built with React for the frontend and Mong that allows users to create, edit, and delete tasks, as well as view and sort them by different criteria such as title, status, and due date. 
                  </p>
                </div>
                <div className="project--card__links">
                  <Link
