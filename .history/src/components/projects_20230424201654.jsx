            ...
            <div className="project--card">
              ...
              <article className="project--card__side project--card__side__back">
                <div className="project--card__content">
                  ...
                  <p className="project--card__content__desc">
                  The task tracker is a web application that was part of a group project for the ongoing <mark. As a frontend developer, I focused on building the task manager page that users interact with after logging in. The app was built with React for the frontend, and Node.js & MongoDB for the backend and database.
                  </p>
                </div>
                <div className="project--card__links">
                  <Link
